...
namespace EasyWiFi.ServerControls
{
    ...
    {
		[Serializable]
		public class OnStringChanged : UnityEvent<string> { }

        public string control = "StringData1";
        public EasyWiFiConstants.PLAYER_NUMBER player = EasyWiFiConstants.PLAYER_NUMBER.Player1;
        //public string notifyMethod = "yourMethod";
		public OnStringChanged  m_strOnStringChanged;
		...
		void Start()
		{
			if (m_strOnStringChanged == null)
			{
				m_strOnStringChanged = new OnStringChanged();
			}
		}
        ...
        public void mapDataStructureToAction(int index)
        {
			...
			{
				//SendMessage(m_fOnStringChanged, stringController[index], SendMessageOptions.DontRequireReceiver);
				m_strOnStringChanged.Invoke(stringController[index].STRING_VALUE);
			}
            else
            {
