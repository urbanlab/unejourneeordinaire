...
namespace EasyWiFi.ServerControls
{
    ...
    public class CustomFloatDataServerController : MonoBehaviour, IServerController
    {
        ...
        public OnFloatChanged m_fOnFloatChanged;
        ...
        void Start()
        {
            if (m_fOnFloatChanged == null)
            {
                m_fOnFloatChanged = new OnFloatChanged();
            }
        }
        ...
        public void mapDataStructureToAction(int index)
        {
            ...
            m_fOnFloatChanged.Invoke(floatController[index].FLOAT_VALUE);
        }
