...
//	{
//		return (Texture2D) GetComponent<MeshRenderer>().material.mainTexture;
//	}
//
...
//		return true;
//	#else
//		return Call_GetStatus() != MEDIAPLAYER_STATE.NOT_READY;
//	#endif
//	}
//	
//	public void SetBackground(Texture2D a_oBackground)
//	{
//		if (a_oBackground != null) 
//		{
//			GetComponent<MeshRenderer> ().material.mainTexture = null;
//			GetComponent<MeshRenderer> ().material.mainTexture = a_oBackground;
//		}
//	}
//	
//	public void SetVideoIntent(string strFileName)
//	{
...
//	}
//	
//	public void Call_Load_OnUiThread()
//	{
//		Call_Load (m_strFileName, 0);
//	}
//	
...
//	}
//	
//	private bool Try_Call_Load(string strFileName)
//	{
//		try
//		{
...
//		else
//		{
//			return Try_Call_Load(strFileName);
//		}
//		#else
//		return Try_Call_Load(strFileName);
//		#endif
...
//		{
//			
//			if( !System.IO.Directory.Exists( Application.persistentDataPath + "/Data"))
